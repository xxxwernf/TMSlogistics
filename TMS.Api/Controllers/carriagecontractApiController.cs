...
namespace TMS.Api.Controllers
{
    ...
    public class carriagecontractApiController : ControllerBase
    {
        ...
        public IActionResult Add(carriagecontractModel s)
        {
            try
            {
                var tianjia = _carriagecontractIDAL.Add(s);
                m_Logger.LogInformation("测试成功");
        ...
        public IActionResult del(int id)
        {
            try
            {
                int shanchu = _carriagecontractIDAL.Del(id);
        ...
        public IActionResult Fantian(int id)
        {
            try
            {
                var fan = _carriagecontractIDAL.Fantian(id);
                return Ok(fan);
            }
            catch (Exception ex)
            {
        ...
        public IActionResult Update(carriagecontractModel s)
        {
            try
            {
                var xiugai = _carriagecontractIDAL.Update(s);
