...
namespace TMS.Api.Controllers
{
    ...
    [ApiController]
    public class GeneralmanagementApiController : ControllerBase
    {
        //依赖注入的名字
        ...
        public GeneralmanagementApiController(ILoggerFactory loggerFactory, EntryIDAL entryIDAL, Token _token)
        {
