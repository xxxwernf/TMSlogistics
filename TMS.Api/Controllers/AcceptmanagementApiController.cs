...
namespace TMS.Api.Controllers
{
    ...
    [ApiController]
    public class AcceptmanagementApiController : ControllerBase
    {
        //依赖注入的名字
        ...
        public AcceptmanagementApiController(ILoggerFactory loggerFactory, EntryIDAL entryIDAL, Token _token)
        {
